 	...
 	<div class="container">
 		<div class="signin-content">
 			<div class="signin-image">
 				...
 				<a href="sign-up.php" class="signup.image-link">
 					Don't have an account?
 					Create an account 
 				</a>
            <a href="sign-in-store.php"><div class="form-group form-button">
                  <input type="" name="" id="submit" class="form-submit" value="Sign In as Store Owner">
