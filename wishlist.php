   ...
   <!--  Preloader  -->
    ...
    <header class="header-section ">
      ...
      <div class="profile" class="nav-item">
         ...
         <a style="color: white;" href="wishlist.php"><i class="fas fa-heart"></i><span style="color: white;">(<?= $count_wishlist_items->rowCount(); ?>)</span></a>
         <a style="color: white" href="cart.php"><i class="fas fa-shopping-cart"></i><span style="color: white;">(<?= $count_cart_items->rowCount(); ?>)</span></a>
                    ...
                    <div class="custom-nevbar__left">
                        ...
                        <ul class="custom-nevbar__nav mb-lg-0">
                            <li class="menu_item dropdown">
                                <a class="menu_link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Order</a>
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" class="active" href="order.php"></a></li>
                                </ul>
                            </li>
                            <li class="menu_item dropdown">
...
<section class="wishlist">
   ...
   <div class="wishlist-total">
      <p>Grand Total of Wistlist : <span>£<?= $grand_total; ?></span></p>
